...
**Precision** measures ability of model to avoid false positives.
Higher precision indicates fewer false positives, meaning fewer instances are incorrectly predicted as *major mode*.
```{r}
precision <- TP / (FP + TP)
...
**Specificity** provides insight into how well the model performs in identifying instances of the negative class correctly.
A high specificity indicates that the model has a low FP rate, meaning it effectively identifies TN without misclassifying them as positives.
```{r}
